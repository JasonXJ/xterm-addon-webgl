...
class BaseRenderLayer {
    ...
    _initCanvas() {
        this._ctx = (0, WebglUtils_1.throwIfFalsy)(this._canvas.getContext('2d', { alpha: this._alpha }));
        if (!this._alpha) {
            this._clearAll();
        }
    }
    ...
    _refreshCharAtlas(terminal, colorSet) {
        ...
        this._charAtlas = (0, CharAtlasCache_1.acquireCharAtlas)(terminal, colorSet, this._scaledCellWidth, this._scaledCellHeight, this._scaledCharWidth, this._scaledCharHeight);
